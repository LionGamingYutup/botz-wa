...
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'Fangzz' //ubah jadi nama mu, note tanda ' gausah di hapus!
global.botname = 'Fangz-Md' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
global.footer = 'FangzGanz' //ubah jadi nama mu, note tanda ' gausah di hapus!

//—————「 Set Kebutuhan Button & Kontak 」—————//
//ubah aja kalau ada yang gapunya gsh di hps anggap aja credits :), note tanda ' gausah di hapus!
global.youtube = 'https://discord.gg/54Wmn2Gb'
...
//—————「 Set Wm 」—————//
global.packname = '© FangzBotz-Md' //ubah jadi nama bot mu, note tanda ' gausah di hapus!
